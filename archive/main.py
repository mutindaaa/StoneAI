...
def main():
    # Read Video
    video_path = 'input_videos/test_30sec.mp4'
    video_frames = read_video(video_path)

    # Get video properties for accurate calculations
    ...
    # Speed and distance estimator (with correct FPS for accurate calculations)
    ...
    # Detect Jersey Numbers (OCR)
    print("Detecting jersey numbers...")
    jersey_detector = JerseyNumberDetector(use_ocr=True)
    jersey_detector.add_jersey_numbers_to_tracks(video_frames, tracks, sample_interval=30)
